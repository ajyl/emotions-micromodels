...
utterance_component = dcc.Loading(
    id="loading-utterance",
    children=[
        dbc.Card(
            [
                ...
                dbc.CardHeader(
                    dbc.Tabs(
                        [
                            dbc.Tab(
                                label="Emotions", tab_id="utterance-tab-1"
                            ),
                            dbc.Tab(
                                label="MITI Codes", tab_id="utterance-tab-2"
                            ),
...
micromodel_component = dcc.Loading(
    id="loading-mms",
    children=[
        dbc.Card(
            [
